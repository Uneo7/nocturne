...
namespace Nocturne.Connectors.GlookoXt.Tests.Mappers;
...
public class GlookoXtGlucoseUnitsTests
{
    ...
    {
        GlookoXtGlucoseUnits.Effective("Auto", Nocturne.Connectors.GlookoXt.Models.GlookoXtGlucoseUnitSetting.Mmol).Should().Be("mmol");
        GlookoXtGlucoseUnits.Effective("mgdl", Nocturne.Connectors.GlookoXt.Models.GlookoXtGlucoseUnitSetting.Mmol).Should().Be("mgdl");
